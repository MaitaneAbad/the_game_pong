export default class BallPong {
  ...
  collisionPlayer1() {
    if (
      this.div.offsetLeft <= 30 - this.barra1.div.clientWidth &&
      this.div.offsetTop >= this.barra1.div.offsetTop &&
      this.div.offsetTop <=
        this.barra1.div.offsetTop + this.barra1.div.clientHeight
    ) {
      return true;
    }
  ...
  collisionPlayer2() {
    if (
      this.div.offsetLeft >= 770 - this.barra2.div.clientWidth &&
      this.div.offsetTop >= this.barra2.div.offsetTop &&
      this.div.offsetTop <=
        this.barra2.div.offsetTop + this.barra2.div.clientHeight
    ) {
      return true;
    }
    return false;
